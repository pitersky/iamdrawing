...
(function () {
  ...
  var __vue_render__ = function() {
    ...
    return _c("div", { staticClass: "flex flex-wrap -m-3" }, [
      _c(
        "div",
        { staticClass: "w-full p-3 md:w-1/2 lg:w-1/4" },
        [
          _c("vue-instagram", {
            attrs: {
              token: "dcscdscsdcsdcsded23e2e",
              count: 5,
  ...
  var script$2 = {
    name: "Product",
    components: {ProductDetail: __vue_component__$1},
    data() {
      return {
        product: {}
      };
        ...
        _c(
          ...
          [
            _c(
              ...
              [_c("span", [_vm._v("Instagram login test")])]
            )
          ],
          1
        )
